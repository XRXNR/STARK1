...
print(CmdSitting)
if CmdSitting then
local ResRedis =  redis:del(stark..CmdSitting..msg.chat_id_)
...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"ليس لديك صلاحية التحكم الادمن , ارجو المعذرة ❤️",true) end
if ResRedis == 0 then redis:set(stark..CmdSitting..msg.chat_id_,true) end
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التعديل » '..(redis:get(stark..'lock_edit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_edit"},'
..'{"text": " الروابط » '..(redis:get(stark..'lock_link'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_link"}],'

..'[{"text": " التاك » '..(redis:get(stark..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_tag"},'
..'{"text": " المعرفات » '..(redis:get(stark..'lock_username'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_username"}],'

..'[{"text": " التكرار » '..(redis:get(stark..'lock_flood'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_flood"},'
..'{"text": " الكلايش » '..(redis:get(stark..'lock_spam'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_spam"}],'

..'[{"text": " الويب » '..(redis:get(stark..'lock_webpage'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_webpage"},'
..'{"text": " الماركدوان » '..(redis:get(stark..'lock_markdown'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_markdown"}],'

..'[{"text": " البوتات بالطرد » '..(redis:get(stark..'lock_bots_by_kick'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots_by_kick"},'
..'{"text": " البوتات » '..(redis:get(stark..'lock_bots'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots"}],'

..'[{"text": " الاضافه » '..(redis:get(stark..'lock_Add'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_Add"},'
..'{"text": " الاشعارات » '..(redis:get(stark..'mute_tgservice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_tgservice"}],'

..'[{"text": " الفشار » '..(redis:get(stark..'lock_mmno3'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_mmno3"},'
..'{"text": " الفارسيه » '..(redis:get(stark..'lock_pharsi'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_pharsi"}],'

..'[{"text": " الانكليزيه » '..(redis:get(stark..'lock_lang'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_lang"},'
..'{"text": " التوجيه » '..(redis:get(stark..'mute_forward'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_forward"}],'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " المتحركه » '..(redis:get(stark..'mute_gif'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_gif"},'
..'{"text": " الدردشه » '..(redis:get(stark..'mute_text'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_text"}],'

..'[{"text": " الانلاين » '..(redis:get(stark..'mute_inline'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_inline"},'
..'{"text": " الالعاب » '..(redis:get(stark..'mute_game'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_game"}],'

..'[{"text": " الصور » '..(redis:get(stark..'mute_photo'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_photo"},'
..'{"text": " الفيديو » '..(redis:get(stark..'mute_video'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_video"}],'

..'[{"text": " الصوت » '..(redis:get(stark..'mute_audio'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_audio"},'
..'{"text": " البصمات » '..(redis:get(stark..'mute_voice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_voice"}],'

..'[{"text": " الملصقات » '..(redis:get(stark..'mute_sticker'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_sticker"},'
..'{"text": " الجهات » '..(redis:get(stark..'mute_contact'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_contact"}],'

..'[{"text": " الموقع » '..(redis:get(stark..'mute_location'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_location"},'
..'{"text": " الملفات » '..(redis:get(stark..'mute_document'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_document"}],'
..'[{"text": "- رجوع » ","callback_data": "CmdBack1"},{"text": "- اخفاء الامر","callback_data": "LoginOut"}]'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " الايدي » '..(redis:get(stark..'lock_id'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_id"},'
..'{"text": " التاك للكل » '..(redis:get(stark..'lock_takkl'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_takkl"}],'

..'[{"text": " الترحيب » '..(redis:get(stark..'welcome:get'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#welcome:get"},'
..'{"text": " الردود » '..(redis:get(stark..'replay'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#replay"}],'

..'[{"text": " الردود العشوائيه » '..(redis:get(stark..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_tag"},'
..'{"text": " التحذير » '..(redis:get(stark..'lock_woring'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_woring"}],'

..'[{"text": " تاك » '..(redis:get(stark..'lock_RandomRdod'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_RandomRdod"},'
..'{"text": " الرابط » '..(redis:get(stark..'lock_linkk'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_linkk"}],'

..'[{"text": " المغادره » '..(redis:get(stark..'lock_leftgroup'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_leftgroup"},'
..'{"text": " الحظر » '..(redis:get(stark..'lock_KickBan'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_KickBan"}],'

..'[{"text": " الحمايه » '..(redis:get(stark..'antiedit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#antiedit"},'
..'{"text": " الايدي بالصوره » '..(redis:get(stark..'idphoto'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#idphoto"}],'

..'[{"text": " التحقق » '..(redis:get(stark..'lock_check'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_check"},'
..'{"text": " التنظيف التلقائي » '..(redis:get(stark..'lock_cleaner'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_cleaner"}],'
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1127044647 or msg.sender_user_id_ == 1127044647 then 
Adminn = true
elseif redis:sismember(stark..':SUDO_BOT:',msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(stark..':Malk_Group:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(stark..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(stark..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(stark..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(stark..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
end
return Adminn 
end
...
download_file('https://raw.githubusercontent.com/BBLBB0/STARK/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/BBLBB0/STARK/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/BBLBB0/STARK/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/BBLBB0/STARK/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝-* تم تحديث السورس الى اصدار *v'..redis:get(stark..":VERSION")..'*\n📟-* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(stark..":NameBot:") or "ستارك"
...
Fshar_Word , res = https.request('https://api.th3stark.com/Words_Fshars.txt')
...
result = false
if msg.sender_user_id_ == 1127044647 or msg.sender_user_id_ == 1127044647 then 
SudoBase = true
...
var = redis:get(stark..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(stark..':SUDO_BOT:',UserID) then
var = redis:get(stark..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(stark..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(stark..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(stark..':Malk_Group:'..ChatID,UserID) then
var = redis:get(stark..":RtbaNew8:"..ChatID) or ' المالك 👷🏽' 
elseif redis:sismember(stark..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(stark..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(stark..'owners:'..ChatID,UserID) then
var = redis:get(stark..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(stark..'admins:'..ChatID,UserID) then
var = redis:get(stark..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(stark..'whitelist:'..ChatID,UserID) then
var = redis:get(stark..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(stark..':NameBot:'))
...
if msg.edited then
redis:incr(stark..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(stark..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(stark..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(stark..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(stark..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(stark..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(stark..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(stark..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(stark..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(stark..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(stark..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(stark..'owners:'..msg.chat_id_)
local Admins = redis:smembers(stark..'admins:'..msg.chat_id_)
local mmez = redis:smembers(stark..'whitelist:'..msg.chat_id_)
...
message = message ..i.. '-l ['..info.username..'](t.me/XRXNR) \n'
end
...
local list = redis:smembers(stark..':SUDO_BOT:')
message = '- قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(stark..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا  *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(stark..'username:'..v)
local count = redis:scard(stark..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/XRXNR) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/XRXNR) l » (`' ..v.. '`) \n'
end
end
end
...
local list = redis:smembers(stark..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(stark..':Malk_Group:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(stark..'admins:'..msg.chat_id_)
...
local list = redis:smembers(stark..'whitelist:'..msg.chat_id_)
...
if redis:sismember(stark..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local res = https.request("http://api.th3stark.com/CheckUser/?User="..User)
if res == "false" then return true else return false end
end


function MuteUser_list(msg)
local list = redis:smembers(stark..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(stark..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(stark..'bannedpv')
if #list==0 then return "- قائمة المحظورين فارغة " end
message = '-قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
local info = redis:hgetall(stark..'username:'..v)
...
if redis:sismember(stark..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(stark..'gban_users')
...
local list = redis:smembers(stark..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(stark..':Filter_Word:'..msg.chat_id_,word) then 
return  "- الكلمه *{"..word.."}* هي بالتاكيد من قائمه المنع." 
else
redis:sadd(stark..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(stark..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(stark..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(stark..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(stark..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..stark..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(stark..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(stark..'group:name'..GroupS) or '')
...
local admins = redis:smembers(stark..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(stark..'username:'..value)
if info then 
...
local creator = redis:smembers(stark..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(stark..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(stark..'group:ids')
message = '-قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(stark..'group:name'..v)
if info then 
...
redis:del(
stark..'group:add'..id_group,
stark..'lock_link'..id_group, 
stark..'lock_id'..id_group,
stark..'lock_spam'..id_group, 
stark..'lock_webpage'..id_group,
stark..'lock_markdown'..id_group,
stark..'lock_flood'..id_group,
stark..'lock_bots'..id_group,
stark..'mute_forward'..id_group,
stark..'mute_contact'..id_group,
stark..'mute_location'..id_group,
stark..'mute_document'..id_group,
stark..'mute_keyboard'..id_group,
stark..'mute_game'..id_group,
stark..'mute_inline'..id_group,
stark..'lock_username'..id_group,
stark..'num_msg_max'..id_group,
stark..'mute_text'..id_group,
stark..'admins:'..id_group,
stark..':Filter_Word:'..id_group,
stark..'banned:'..id_group,
stark..'is_silent_users:'..id_group,
stark..'whitelist:'..id_group,
stark..':MONSHA_BOT:'..id_group,
stark..'owners:'..id_group,
stark..'replay'..id_group,
stark..':MONSHA_Group:'..id_group,
stark..':Malk_Group:'..id_group
)
redis:srem(stark..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(stark..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(stark..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(stark..'admins:'..arg.chat_id_,data.id_)
...
function modadd(msg)
if redis:get(stark..'lock_service') then
lock_servicez = true
else
lock_servicez = false
end
...
if redis:get(stark..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'- المجموعه بالتاكيد ✓️ تم تفعيلها \n- بواسطه ⋙「 '..NameUser..' 」 \n') end
...
local GroupUsers = tonumber(redis:get(stark..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(stark..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(stark..':Malk_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
stark..'group:add'..arg.chat_id_,true,
stark..'lock_link'..arg.chat_id_,true, 
stark..'lock_id'..arg.chat_id_,true,
stark..'lock_spam'..arg.chat_id_,true,
stark..'lock_webpage'..arg.chat_id_,true,
stark..'lock_markdown'..arg.chat_id_,true,
stark..'lock_flood'..arg.chat_id_,true,
stark..'lock_bots'..arg.chat_id_,true,
stark..'mute_forward'..arg.chat_id_,true,
stark..'mute_contact'..arg.chat_id_,true,
stark..'mute_location'..arg.chat_id_,true,
stark..'mute_document'..arg.chat_id_,true,
stark..'mute_keyboard'..arg.chat_id_,true,
stark..'mute_game'..arg.chat_id_,true,
stark..'mute_inline'..arg.chat_id_,true,
stark..'lock_username'..arg.chat_id_,true,
stark..'num_msg_max'..arg.chat_id_,5, 
stark..'lock_edit'..arg.chat_id_,true,
stark..'replay'..arg.chat_id_,true,
stark..'lock_rdodSource'..arg.chat_id_,true,
stark.."lock_KickBan"..msg.chat_id_,true,
stark.."lock_mmno3"..msg.chat_id_,true,
stark.."lock_KickBan"..msg.chat_id_,true,
stark.."lock_RandomRdod"..msg.chat_id_,true,
stark.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(stark..'group:ids',arg.chat_id_) 
redis:sadd(stark..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(stark..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(stark..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:sadd(stark..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم تقييده بنجاح ✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(stark..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم فك تقييده بنجاح ")
end
if cmd == "setwhitelist" then
if redis:sismember(stark..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مميز  في المجموعه ✓") 
end
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:sadd(stark..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مميز  في المجموعه ✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(stark..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مميز  في المجموعه ✓") 
end
redis:srem(stark..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مميز  في المجموعه ✓") 
end
if cmd == "setmnsha" then
if redis:sismember(stark..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ  في المجموعه ✓") 
end
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:sadd(stark..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ  في المجموعه ✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(stark..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ  في المجموعه ") 
end
redis:srem(stark..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشى  في المجموعه ✓") 
end

if cmd == "setowner" then
if redis:sismember(stark..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مدير  في المجموعه ✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:sadd(stark..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مدير  في المجموعه ✓") 
end
if cmd == "remowner" then
if not redis:sismember(stark..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مدير  في المجموعه ✓") 
end
redis:srem(stark..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مدير  في المجموعه ✓") 
end
if cmd == "promote" then
if redis:sismember(stark..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه ادمن  في المجموعه ✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:sadd(stark..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه ادمن  في المجموعه ✓") 
end
if cmd == "demote" then
if not redis:sismember(stark..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله ادمن  في المجموعه ✓") 
end
redis:srem(stark..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(stark..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ اساسي  في المجموعه ✓") 
end
redis:hset(stark..'username:'..UserID,'username',USERNAME)
redis:sadd(stark..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ اساسي  في المجموعه ✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(stark..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ اساسي  في المجموعه ✓") 
end
redis:srem(stark..':MONSHA_Group:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشئ اساسي  في المجموعه ✓") 
end


if cmd == "UpMalk" then
if redis:sismember(stark..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعه ✓") 
end
redis:hset(stark..'username:'..UserID,'username',USERNAME)
redis:sadd(stark..':Malk_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعه ✓") 
end

if cmd == "DwnMalk" then
if not redis:sismember(stark..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعه ✓") 
end
redis:srem(stark..':Malk_Group:'..ChatID,UserID) 
...
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:sadd(stark..'banned:'..ChatID,UserID)
...
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:srem(stark..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:sadd(stark..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم كتمه  من المجموعه ✓") 
end
...
redis:hset(stark..'username:'..UserID, 'username', Resolv)
redis:srem(stark..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم الغاء كتمه  من المجموعه ✓") 
end

if cmd == "upMshrf" then
redis:hset(stark..'username:'..UserID,'username',Resolv)
redis:setex(stark..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(stark..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
local maseegs = redis:get(stark..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(stark..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(stark..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
if UserID == 1127044647 or UserID == 1127044647 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ❕") end
...
.."\n- التعديل » "..(redis:get(stark..'lock_edit'..msg.chat_id_) or 'false')
.."\n- الروابط » "..(redis:get(stark..'lock_link'..msg.chat_id_) or 'false')
.."\n- التاك » "..(redis:get(stark..'lock_tag'..msg.chat_id_) or 'false')
.."\n- المعرفات » "..(redis:get(stark..'lock_username'..msg.chat_id_) or 'false')
.."\n\n- التكرار » "..(redis:get(stark..'lock_flood'..msg.chat_id_) or 'false')
.."\n- الكلايش » "..(redis:get(stark..'lock_spam'..msg.chat_id_) or 'false')
.."\n- الويب » "..(redis:get(stark..'lock_webpage'..msg.chat_id_) or 'false')
.."\n- الماركدوان » "..(redis:get(stark..'lock_markdown'..msg.chat_id_) or 'false')
.."\n- البوتات بالطرد » "..(redis:get(stark..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n- البوتات » "..(redis:get(stark..'lock_bots'..msg.chat_id_) or 'false')
.."\n- عدد التكرار » "..(redis:get(stark..'num_msg_max'..msg.chat_id_) or 'false')
.."\n- وقت التنظيف » "..(redis:get(stark..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n-` اعدادات الوسائط :`\n"
.."\n- المتحركه » "..(redis:get(stark..'mute_gif'..msg.chat_id_) or 'false')
.."\n- الدردشه » "..(redis:get(stark..'mute_text'..msg.chat_id_) or 'false')
.."\n- الانلاين » "..(redis:get(stark..'mute_inline'..msg.chat_id_) or 'false')
.."\n- الالعاب » "..(redis:get(stark..'mute_game'..msg.chat_id_) or 'false')
.."\n- الصور » "..(redis:get(stark..'mute_photo'..msg.chat_id_) or 'false')
.."\n- الفيديو » "..(redis:get(stark..'mute_video'..msg.chat_id_) or 'false')
.."\n- الصوت » "..(redis:get(stark..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n- البصمات » "..(redis:get(stark..'mute_voice'..msg.chat_id_) or 'false')
.."\n- الملصقات » "..(redis:get(stark..'mute_sticker'..msg.chat_id_) or 'false')
.."\n- الجهات » "..(redis:get(stark..'mute_contact'..msg.chat_id_) or 'false')
.."\n- التوجيه » "..(redis:get(stark..'mute_forward'..msg.chat_id_) or 'false')
.."\n- الموقع » "..(redis:get(stark..'mute_location'..msg.chat_id_) or 'false')
.."\n- الملفات » "..(redis:get(stark..'mute_document'..msg.chat_id_) or 'false')
.."\n- الاشعارات » "..(redis:get(stark..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n- الفشار » "..(redis:get(stark..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n- الفارسيه » "..(redis:get(stark..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n- الانكليزيه » "..(redis:get(stark..'lock_lang'..msg.chat_id_) or 'false')
.."\n- الاضافه » "..(redis:get(stark..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n-` اعدادات اخرى : `"
.."\n- الترحيب » "..(redis:get(stark..'welcome:get'..msg.chat_id_) or 'false')
.."\n-  الردود » "..(redis:get(stark..'replay'..msg.chat_id_) or 'false')
.."\n-  الردود العشوائيه » "..(redis:get(stark.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n-  التحذير » "..(redis:get(stark..'lock_woring'..msg.chat_id_) or 'false')
.."\n- الايدي » "..(redis:get(stark..'lock_id'..msg.chat_id_) or 'false')
.."\n- الرابط » "..(redis:get(stark..'lock_linkk'..msg.chat_id_) or 'false')
.."\n- المغادره » "..(redis:get(stark..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n- الحظر » "..(redis:get(stark..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n- الحمايه » "..(redis:get(stark..'antiedit'..msg.chat_id_) or 'false')
.."\n- التاك للكل » "..(redis:get(stark..'lock_takkl'..msg.chat_id_) or 'false')
.."\n- الايدي بالصوره » "..(redis:get(stark..'idphoto'..msg.chat_id_) or 'false')
.."\n- التحقق » "..(redis:get(stark.."lock_check"..msg.chat_id_) or 'false')
.."\n- التنظيف التلقائي » "..(redis:get(stark.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n- ردود السورس » "..(redis:get(stark.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n- عدد التكرار » "..(redis:get(stark..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n-` اعدادات التقـييد :`\n"
.."\n- التقييد بالتوجيه » "..(redis:get(stark..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n- التقييد بالصور » "..(redis:get(stark..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n- التقييد بالروابط » "..(redis:get(stark..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n- التقييد بالمتحركه » "..(redis:get(stark..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n- التقييد الفيديو » "..(redis:get(stark..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n- الملفات » "..(redis:get(stark..'mute_document'..msg.chat_id_) or 'false')
.."\n- الاشعارات » "..(redis:get(stark..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n- الكيبورد » "..(redis:get(stark..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
